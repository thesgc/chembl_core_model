...
class MoleculeDictionary(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    structure_key = ChemblCharField(max_length=27, db_index=True, blank=True, null=True, help_text=u'Note unique key removed for Chembiohub - Unique key for the structure/sequence (e.g., inchi_key or sequence md5sum) to help enforce non-redundancy.')
    ...
    project = models.ForeignKey("cbh_core_model.Project", blank=True, null=True)
